...
import { sendErrorMessage } from "@/action/error";
...
export default function Error({ error, reset }: ErrorProps) {
  ...
  return (
    <MainLayout>
      <MainViews>
        <section className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <figure className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
          <svg
